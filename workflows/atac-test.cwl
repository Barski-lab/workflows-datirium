...
'sd:upstream':
  ...
  - "trim-atacseq-pe.cwl"
  - "trim-atacseq-se.cwl"
  - "trim-atacseq-pe-dutp.cwl"
  - "trim-atacseq-pe-smarter-dutp.cwl"
  - "trim-atacseq-se-dutp.cwl"
  ...
  - "https://github.com/datirium/workflows/workflows/trim-atacseq-pe-dutp.cwl"
  - "https://github.com/datirium/workflows/workflows/trim-atacseq-pe-smarter-dutp.cwl"
  - "https://github.com/datirium/workflows/workflows/trim-atacseq-se-dutp.cwl"
...
inputs:
  ...
  peak_files_cond_1:
    ...
    label: "ATAC-seq experiments (condition 1, aka 'untreated')"
    doc: "CSV/TSV input files grouped by isoforms (condition 1, aka 'untreated')"
    'sd:upstreamSource': "atacseq_cond_1/peak_files"
    'sd:localLabel': true
  ...
  peak_files_cond_2:
    ...
    default: null
    format: "http://edamontology.org/format_3752"
    label: "ATAC-seq experiments (condition 2, aka 'treated')"
    doc: "CSV/TSV input files grouped by isoforms (condition 2, aka 'treated')"
    'sd:upstreamSource': "atacseq_cond_2/peak_files"
    'sd:localLabel': true
  ...
  sample_names_cond_1:
    type:
      ...
      - string[]
    default: null
    label: "Sample names for ATAC-seq experiments (condition 1, aka 'untreated')"
    doc: |
      Aliases for ATAC-seq experiments (condition 1, aka 'untreated') to make the
      legend for generated plots. Order corresponds to the peak_files_cond_1
    'sd:upstreamSource': "atacseq_cond_1/alias"
  ...
  sample_names_cond_2:
    type:
      ...
      - string[]
    default: null 
    label: "Sample names for ATAC-seq experiments (condition 2, aka 'treated')"
    doc: |
      Aliases for ATAC-seq experiments (condition 2, aka 'treated') to make the
      legend for generated plots. Order corresponds to the peak_files_cond_2
    'sd:upstreamSource': "atacseq_cond_2/alias"
...
steps:
  ...
  deseq:
    ...
    in:
      untreated_files:
        source: [group_by, peak_files_cond_1, peak_files_cond_1, peak_files_cond_1]
        valueFrom: |
          ${
              if (self[0] == "isoforms") {
                return self[1];
      ...
      treated_files:
        source: [group_by, peak_files_cond_2, peak_files_cond_2, peak_files_cond_2]
        valueFrom: |
          ${
              if (self[0] == "isoforms") {
                return self[1];
